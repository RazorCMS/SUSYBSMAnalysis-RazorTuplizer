...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   Int_t           nPVAll;
   Float_t         pvAllX[142];   //[nPVAll]
   Float_t         pvAllXError[142];   //[nPVAll]
   Float_t         pvAllY[142];   //[nPVAll]
   Float_t         pvAllYError[142];   //[nPVAll]
   Float_t         pvAllZ[142];   //[nPVAll]
   Float_t         pvAllZError[142];   //[nPVAll]
   Float_t         pvAllT[142];   //[nPVAll]
   Float_t         pvAllTError[142];   //[nPVAll]
   Float_t         pvAllLogSumPtSq[142];   //[nPVAll]
   Float_t         pvAllSumPt[142];   //[nPVAll]
   Float_t         pvAllSumPx[142];   //[nPVAll]
   Float_t         pvAllSumPy[142];   //[nPVAll]
   Float_t         pvAllSumPz[142];   //[nPVAll]
   Float_t         pvPUz[142];   //[nPVAll]
   Int_t           pvNtrack[142];   //[nPVAll]
   Int_t           pvNtrack_reco[142];   //[nPVAll]
   Int_t           pvIndex[142];   //[nPVAll]
   Int_t           allNtrack;
   ...
   Float_t         pvAllLogSumPtSq_dt[142];   //[nPVAll]
   Float_t         pvAllSumPt_dt[142];   //[nPVAll]
   Float_t         pvAllSumPx_dt[142];   //[nPVAll]
   Float_t         pvAllSumPy_dt[142];   //[nPVAll]
   Float_t         pvAllSumPz_dt[142];   //[nPVAll]
   Int_t           pvNtrack_dt[142];   //[nPVAll]
   Int_t           nBunchXing;
   Int_t           BunchXing[7];   //[nBunchXing]
   Int_t           BunchXingIndex[7];   //[nBunchXing]
   Int_t           nPU[7];   //[nBunchXing]
   Float_t         nPUmean[7];   //[nBunchXing]
   vector<float>   *puZposition;
   ...
   Float_t         ele_IDMVATrig[20];   //[nElectrons]
   Float_t         ele_IDMVANonTrig[20];   //[nElectrons]
   ...
   Int_t           nTaus;
   Float_t         tauE[7];   //[nTaus]
   Float_t         tauPt[7];   //[nTaus]
   Float_t         tauEta[7];   //[nTaus]
   Float_t         tauPhi[7];   //[nTaus]
   Bool_t          tau_IsLoose[7];   //[nTaus]
   Bool_t          tau_IsMedium[7];   //[nTaus]
   Bool_t          tau_IsTight[7];   //[nTaus]
   Bool_t          tau_passEleVetoLoose[7];   //[nTaus]
   Bool_t          tau_passEleVetoMedium[7];   //[nTaus]
   Bool_t          tau_passEleVetoTight[7];   //[nTaus]
   Bool_t          tau_passMuVetoLoose[7];   //[nTaus]
   Bool_t          tau_passMuVetoMedium[7];   //[nTaus]
   Bool_t          tau_passMuVetoTight[7];   //[nTaus]
   UInt_t          tau_ID[7];   //[nTaus]
   Float_t         tau_combinedIsoDeltaBetaCorr3Hits[7];   //[nTaus]
   Float_t         tau_chargedIsoPtSum[7];   //[nTaus]
   Float_t         tau_neutralIsoPtSum[7];   //[nTaus]
   Float_t         tau_puCorrPtSum[7];   //[nTaus]
   Float_t         tau_eleVetoMVA[7];   //[nTaus]
   Int_t           tau_eleVetoCategory[7];   //[nTaus]
   Float_t         tau_muonVetoMVA[7];   //[nTaus]
   Float_t         tau_isoMVAnewDMwLT[7];   //[nTaus]
   Float_t         tau_isoMVAnewDMwoLT[7];   //[nTaus]
   Float_t         tau_leadCandPt[7];   //[nTaus]
   Int_t           tau_leadCandID[7];   //[nTaus]
   Float_t         tau_leadChargedHadrCandPt[7];   //[nTaus]
   Int_t           tau_leadChargedHadrCandID[7];   //[nTaus]
   ...
   Float_t         pho_sumChargedHadronPtAllVertices[3][600];   //[nPhotons]
   Float_t         pho_sumChargedHadronPt[3];   //[nPhotons]
   Float_t         pho_sumChargedHadronPt_NewPV_NoTiming[3];   //[nPhotons]
   Float_t         pho_sumChargedHadronPt_NewPV_Timing50_TrkVtx[3];   //[nPhotons]
   Float_t         pho_sumChargedHadronPt_NewPV_Timing80_TrkVtx[3];   //[nPhotons]
   Float_t         pho_sumChargedHadronPt_NewPV_Timing100_TrkVtx[3];   //[nPhotons]
   Float_t         pho_sumChargedHadronPt_NewPV_Timing120_TrkVtx[3];   //[nPhotons]
   Float_t         pho_sumChargedHadronPt_NewPV_Timing50_TrkPho[3];   //[nPhotons]
   Float_t         pho_sumChargedHadronPt_NewPV_Timing80_TrkPho[3];   //[nPhotons]
   Float_t         pho_sumChargedHadronPt_NewPV_Timing100_TrkPho[3];   //[nPhotons]
   Float_t         pho_sumChargedHadronPt_NewPV_Timing120_TrkPho[3];   //[nPhotons]
   Float_t         pho_sumNeutralHadronEt[3];   //[nPhotons]
   Float_t         pho_sumPhotonEt[3];   //[nPhotons]
   Float_t         pho_sumWorstVertexChargedHadronPt[3];   //[nPhotons]
   Float_t         pho_pfIsoChargedHadronIso[3];   //[nPhotons]
   Float_t         pho_pfIsoChargedHadronIsoWrongVtx[3];   //[nPhotons]
   Float_t         pho_pfIsoNeutralHadronIso[3];   //[nPhotons]
   Float_t         pho_pfIsoPhotonIso[3];   //[nPhotons]
   Float_t         pho_pfIsoModFrixione[3];   //[nPhotons]
   Float_t         pho_pfIsoSumPUPt[3];   //[nPhotons]
   Bool_t          pho_isConversion[3];   //[nPhotons]
   Bool_t          pho_passEleVeto[3];   //[nPhotons]
   Float_t         pho_RegressionE[3];   //[nPhotons]
   Float_t         pho_RegressionEUncertainty[3];   //[nPhotons]
   Float_t         pho_IDMVA[3];   //[nPhotons]
   Float_t         pho_superClusterEnergy[3];   //[nPhotons]
   Float_t         pho_superClusterRawEnergy[3];   //[nPhotons]
   Float_t         pho_superClusterEta[3];   //[nPhotons]
   Float_t         pho_superClusterPhi[3];   //[nPhotons]
   Float_t         pho_superClusterX[3];   //[nPhotons]
   Float_t         pho_superClusterY[3];   //[nPhotons]
   Float_t         pho_superClusterZ[3];   //[nPhotons]
   Float_t         pho_superClusterSeedX[3];   //[nPhotons]
   Float_t         pho_superClusterSeedY[3];   //[nPhotons]
   Float_t         pho_superClusterSeedZ[3];   //[nPhotons]
   Float_t         pho_superClusterSeedT[3];   //[nPhotons]
   Float_t         pho_superClusterSeedE[3];   //[nPhotons]
   Float_t         pho_pfClusterSeedE[3];   //[nPhotons]
   Bool_t          pho_hasPixelSeed[3];   //[nPhotons]
   Bool_t          pho_passHLTFilter[3][100];   //[nPhotons]
   Int_t           pho_convType[3];   //[nPhotons]
   Float_t         pho_convTrkZ[3];   //[nPhotons]
   Float_t         pho_convTrkClusZ[3];   //[nPhotons]
   Float_t         pho_vtxSumPx[3][600];   //[nPhotons]
   Float_t         pho_vtxSumPy[3][600];   //[nPhotons]
   Int_t           nJets;
   Float_t         jetE[177];   //[nJets]
   Float_t         jetPt[177];   //[nJets]
   Float_t         jetEta[177];   //[nJets]
   Float_t         jetPhi[177];   //[nJets]
   Float_t         jetCSV[177];   //[nJets]
   Float_t         jetCISV[177];   //[nJets]
   Float_t         jetMass[177];   //[nJets]
   Float_t         jetJetArea[177];   //[nJets]
   Float_t         jetPileupE[177];   //[nJets]
   Float_t         jetPileupId[177];   //[nJets]
   Int_t           jetPileupIdFlag[177];   //[nJets]
   Bool_t          jetPassIDLoose[177];   //[nJets]
   Bool_t          jetPassIDTight[177];   //[nJets]
   Bool_t          jetPassMuFrac[177];   //[nJets]
   Bool_t          jetPassEleFrac[177];   //[nJets]
   Int_t           jetPartonFlavor[177];   //[nJets]
   Int_t           jetHadronFlavor[177];   //[nJets]
   Float_t         jetChargedEMEnergyFraction[177];   //[nJets]
   Float_t         jetNeutralEMEnergyFraction[177];   //[nJets]
   Float_t         jetChargedHadronEnergyFraction[177];   //[nJets]
   Float_t         jetNeutralHadronEnergyFraction[177];   //[nJets]
   Float_t         jetMuonEnergyFraction[177];   //[nJets]
   Float_t         jetHOEnergyFraction[177];   //[nJets]
   Float_t         jetHFHadronEnergyFraction[177];   //[nJets]
   Float_t         jetHFEMEnergyFraction[177];   //[nJets]
   Float_t         jetAllMuonPt[177];   //[nJets]
   Float_t         jetAllMuonEta[177];   //[nJets]
   Float_t         jetAllMuonPhi[177];   //[nJets]
   Float_t         jetAllMuonM[177];   //[nJets]
   UInt_t          nFatJets;
   Float_t         fatJetE[42];   //[nFatJets]
   Float_t         fatJetPt[42];   //[nFatJets]
   Float_t         fatJetEta[42];   //[nFatJets]
   Float_t         fatJetPhi[42];   //[nFatJets]
   Float_t         fatJetPrunedM[42];   //[nFatJets]
   Float_t         fatJetTrimmedM[42];   //[nFatJets]
   Float_t         fatJetFilteredM[42];   //[nFatJets]
   Float_t         fatJetTau1[42];   //[nFatJets]
   Float_t         fatJetTau2[42];   //[nFatJets]
   Float_t         fatJetTau3[42];   //[nFatJets]
   Float_t         metPt;
   Float_t         metPhi;
   Float_t         sumMET;
   Float_t         metType0Pt;
   ...
   Int_t           nGenJets;
   Float_t         genJetE[54];   //[nGenJets]
   Float_t         genJetPt[54];   //[nGenJets]
   Float_t         genJetEta[54];   //[nGenJets]
   Float_t         genJetPhi[54];   //[nGenJets]
   Float_t         genMetPt;
   Float_t         genMetPhi;
   Float_t         genVertexZ;
   Float_t         genVertexX;
   ...
   Int_t           nGenParticle;
   Int_t           gParticleMotherId[447];   //[nGenParticle]
   Int_t           gParticleMotherIndex[447];   //[nGenParticle]
   Int_t           gParticleId[447];   //[nGenParticle]
   Int_t           gParticleStatus[447];   //[nGenParticle]
   Float_t         gParticleE[447];   //[nGenParticle]
   Float_t         gParticlePt[447];   //[nGenParticle]
   Float_t         gParticleEta[447];   //[nGenParticle]
   Float_t         gParticlePhi[447];   //[nGenParticle]
