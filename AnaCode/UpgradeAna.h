...
// Tue Jan 30 00:13:19 2018 by ROOT version 6.10/05
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   std::vector<float>   *allTrackT;
   std::vector<float>   *allTrackPt;
   std::vector<float>   *allTrackdZ;
   std::vector<float>   *allTrackPhi;
   std::vector<float>   *allTrackEta;
   ...
   Int_t           nPU[7];   //[nBunchXing]
   Float_t         nPUmean[7];   //[nBunchXing]
   std::vector<float>   *puZposition;
   ...
   Float_t         muon_chargedMiniIso[9];   //[nMuons]
   Float_t         muon_photonAndNeutralHadronMiniIso[9];   //[nMuons]
   Float_t         muon_chargedPileupMiniIso[9];   //[nMuons]
   Float_t         muon_activityMiniIsoAnnulus[9];   //[nMuons]
   ...
   Int_t           nElectrons;
   Float_t         eleE[19];   //[nElectrons]
   Float_t         elePt[19];   //[nElectrons]
   Float_t         eleEta[19];   //[nElectrons]
   Float_t         elePhi[19];   //[nElectrons]
   Float_t         eleCharge[19];   //[nElectrons]
   Float_t         eleEta_SC[19];   //[nElectrons]
   Float_t         eleSigmaIetaIeta[19];   //[nElectrons]
   Float_t         eleFull5x5SigmaIetaIeta[19];   //[nElectrons]
   Float_t         eleR9[19];   //[nElectrons]
   Float_t         ele_dEta[19];   //[nElectrons]
   Float_t         ele_dPhi[19];   //[nElectrons]
   Float_t         ele_HoverE[19];   //[nElectrons]
   Float_t         ele_d0[19];   //[nElectrons]
   Float_t         ele_dZ[19];   //[nElectrons]
   Float_t         ele_ip3d[19];   //[nElectrons]
   Float_t         ele_ip3dSignificance[19];   //[nElectrons]
   Float_t         ele_pileupIso[19];   //[nElectrons]
   Float_t         ele_chargedIso[19];   //[nElectrons]
   Float_t         ele_photonIso[19];   //[nElectrons]
   Float_t         ele_neutralHadIso[19];   //[nElectrons]
   Int_t           ele_MissHits[19];   //[nElectrons]
   Bool_t          ele_PassConvVeto[19];   //[nElectrons]
   Float_t         ele_OneOverEminusOneOverP[19];   //[nElectrons]
   Float_t         ele_IDMVATrig[19];   //[nElectrons]
   Float_t         ele_IDMVANonTrig[19];   //[nElectrons]
   Float_t         ele_RegressionE[19];   //[nElectrons]
   Float_t         ele_CombineP4[19];   //[nElectrons]
   Float_t         ele_ptrel[19];   //[nElectrons]
   Float_t         ele_chargedMiniIso[19];   //[nElectrons]
   Float_t         ele_photonAndNeutralHadronMiniIso[19];   //[nElectrons]
   Float_t         ele_chargedPileupMiniIso[19];   //[nElectrons]
   Float_t         ele_activityMiniIsoAnnulus[19];   //[nElectrons]
   Bool_t          ele_passSingleEleTagFilter[19];   //[nElectrons]
   Bool_t          ele_passTPOneTagFilter[19];   //[nElectrons]
   Bool_t          ele_passTPTwoTagFilter[19];   //[nElectrons]
   Bool_t          ele_passTPOneProbeFilter[19];   //[nElectrons]
   Bool_t          ele_passTPTwoProbeFilter[19];   //[nElectrons]
   Bool_t          ele_passHLTFilter[19][100];   //[nElectrons]
   Int_t           nTaus;
   ...
   Int_t           nPhotons;
   Float_t         phoE[21];   //[nPhotons]
   Float_t         phoPt[21];   //[nPhotons]
   Float_t         phoEta[21];   //[nPhotons]
   Float_t         phoPhi[21];   //[nPhotons]
   Float_t         phoSigmaIetaIeta[21];   //[nPhotons]
   Float_t         phoFull5x5SigmaIetaIeta[21];   //[nPhotons]
   Float_t         phoR9[21];   //[nPhotons]
   Float_t         pho_HoverE[21];   //[nPhotons]
   Float_t         pho_sumChargedHadronPtAllVertices[21][600];   //[nPhotons]
   Float_t         pho_sumChargedHadronPt[21];   //[nPhotons]
   Float_t         pho_sumChargedHadronPt_NewPV_NoTiming[21];   //[nPhotons]
   Float_t         pho_sumChargedHadronPt_NewPV_Timing50_TrkVtx[21];   //[nPhotons]
   Float_t         pho_sumChargedHadronPt_NewPV_Timing80_TrkVtx[21];   //[nPhotons]
   Float_t         pho_sumChargedHadronPt_NewPV_Timing100_TrkVtx[21];   //[nPhotons]
   Float_t         pho_sumChargedHadronPt_NewPV_Timing120_TrkVtx[21];   //[nPhotons]
   Float_t         pho_sumChargedHadronPt_NewPV_Timing50_TrkPho[21];   //[nPhotons]
   Float_t         pho_sumChargedHadronPt_NewPV_Timing80_TrkPho[21];   //[nPhotons]
   Float_t         pho_sumChargedHadronPt_NewPV_Timing100_TrkPho[21];   //[nPhotons]
   Float_t         pho_sumChargedHadronPt_NewPV_Timing120_TrkPho[21];   //[nPhotons]
   Float_t         pho_sumNeutralHadronEt[21];   //[nPhotons]
   Float_t         pho_sumPhotonEt[21];   //[nPhotons]
   Float_t         pho_sumWorstVertexChargedHadronPt[21];   //[nPhotons]
   Float_t         pho_pfIsoChargedHadronIso[21];   //[nPhotons]
   Float_t         pho_pfIsoChargedHadronIsoWrongVtx[21];   //[nPhotons]
   Float_t         pho_pfIsoNeutralHadronIso[21];   //[nPhotons]
   Float_t         pho_pfIsoPhotonIso[21];   //[nPhotons]
   Float_t         pho_pfIsoModFrixione[21];   //[nPhotons]
   Float_t         pho_pfIsoSumPUPt[21];   //[nPhotons]
   Bool_t          pho_isConversion[21];   //[nPhotons]
   Bool_t          pho_passEleVeto[21];   //[nPhotons]
   Float_t         pho_RegressionE[21];   //[nPhotons]
   Float_t         pho_RegressionEUncertainty[21];   //[nPhotons]
   Float_t         pho_IDMVA[21];   //[nPhotons]
   Float_t         pho_superClusterEnergy[21];   //[nPhotons]
   Float_t         pho_superClusterRawEnergy[21];   //[nPhotons]
   Float_t         pho_superClusterEta[21];   //[nPhotons]
   Float_t         pho_superClusterPhi[21];   //[nPhotons]
   Float_t         pho_superClusterX[21];   //[nPhotons]
   Float_t         pho_superClusterY[21];   //[nPhotons]
   Float_t         pho_superClusterZ[21];   //[nPhotons]
   Float_t         pho_superClusterSeedX[21];   //[nPhotons]
   Float_t         pho_superClusterSeedY[21];   //[nPhotons]
   Float_t         pho_superClusterSeedZ[21];   //[nPhotons]
   Float_t         pho_superClusterSeedT[21];   //[nPhotons]
   Float_t         pho_superClusterSeedE[21];   //[nPhotons]
   Float_t         pho_pfClusterSeedE[21];   //[nPhotons]
   Bool_t          pho_hasPixelSeed[21];   //[nPhotons]
   Bool_t          pho_passHLTFilter[21][100];   //[nPhotons]
   Int_t           pho_convType[21];   //[nPhotons]
   Float_t         pho_convTrkZ[21];   //[nPhotons]
   Float_t         pho_convTrkClusZ[21];   //[nPhotons]
   Float_t         pho_vtxSumPx[21][600];   //[nPhotons]
   Float_t         pho_vtxSumPy[21][600];   //[nPhotons]
   Int_t           nJets;
   Float_t         jetE[174];   //[nJets]
   Float_t         jetPt[174];   //[nJets]
   Float_t         jetEta[174];   //[nJets]
   Float_t         jetPhi[174];   //[nJets]
   Float_t         jetCSV[174];   //[nJets]
   Float_t         jetCISV[174];   //[nJets]
   Float_t         jetMass[174];   //[nJets]
   Float_t         jetJetArea[174];   //[nJets]
   Float_t         jetPileupE[174];   //[nJets]
   Float_t         jetPileupId[174];   //[nJets]
   Int_t           jetPileupIdFlag[174];   //[nJets]
   Bool_t          jetPassIDLoose[174];   //[nJets]
   Bool_t          jetPassIDTight[174];   //[nJets]
   Bool_t          jetPassMuFrac[174];   //[nJets]
   Bool_t          jetPassEleFrac[174];   //[nJets]
   Int_t           jetPartonFlavor[174];   //[nJets]
   Int_t           jetHadronFlavor[174];   //[nJets]
   Float_t         jetChargedEMEnergyFraction[174];   //[nJets]
   Float_t         jetNeutralEMEnergyFraction[174];   //[nJets]
   Float_t         jetChargedHadronEnergyFraction[174];   //[nJets]
   Float_t         jetNeutralHadronEnergyFraction[174];   //[nJets]
   Float_t         jetMuonEnergyFraction[174];   //[nJets]
   Float_t         jetHOEnergyFraction[174];   //[nJets]
   Float_t         jetHFHadronEnergyFraction[174];   //[nJets]
   Float_t         jetHFEMEnergyFraction[174];   //[nJets]
   Float_t         jetAllMuonPt[174];   //[nJets]
   Float_t         jetAllMuonEta[174];   //[nJets]
   Float_t         jetAllMuonPhi[174];   //[nJets]
   Float_t         jetAllMuonM[174];   //[nJets]
   UInt_t          nFatJets;
   Float_t         fatJetE[41];   //[nFatJets]
   Float_t         fatJetPt[41];   //[nFatJets]
   Float_t         fatJetEta[41];   //[nFatJets]
   Float_t         fatJetPhi[41];   //[nFatJets]
   Float_t         fatJetPrunedM[41];   //[nFatJets]
   Float_t         fatJetTrimmedM[41];   //[nFatJets]
   Float_t         fatJetFilteredM[41];   //[nFatJets]
   Float_t         fatJetTau1[41];   //[nFatJets]
   Float_t         fatJetTau2[41];   //[nFatJets]
   Float_t         fatJetTau3[41];   //[nFatJets]
   Float_t         metPt;
   Float_t         metPhi;
   Float_t         sumMET;
   Float_t         metType0Pt;
   ...
   Int_t           nGenJets;
   Float_t         genJetE[52];   //[nGenJets]
   Float_t         genJetPt[52];   //[nGenJets]
   Float_t         genJetEta[52];   //[nGenJets]
   Float_t         genJetPhi[52];   //[nGenJets]
   Float_t         genMetPt;
   Float_t         genMetPhi;
   Float_t         genVertexZ;
   Float_t         genVertexX;
   ...
   Int_t           nGenParticle;
   Int_t           gParticleMotherId[395];   //[nGenParticle]
   Int_t           gParticleMotherIndex[395];   //[nGenParticle]
   Int_t           gParticleId[395];   //[nGenParticle]
   Int_t           gParticleStatus[395];   //[nGenParticle]
   Float_t         gParticleE[395];   //[nGenParticle]
   Float_t         gParticlePt[395];   //[nGenParticle]
   Float_t         gParticleEta[395];   //[nGenParticle]
   Float_t         gParticlePhi[395];   //[nGenParticle]
   ...
   TBranch        *b_nPVAll;   //!
   TBranch        *b_pvAllX;   //!
   TBranch        *b_pvAllXError;   //!
   TBranch        *b_pvAllY;   //!
   TBranch        *b_pvAllYError;   //!
   TBranch        *b_pvAllZ;   //!
   TBranch        *b_pvAllZError;   //!
   TBranch        *b_pvAllT;   //!
   TBranch        *b_pvAllTError;   //!
   TBranch        *b_pvAllLogSumPtSq;   //!
   TBranch        *b_pvAllSumPt;   //!
   TBranch        *b_pvAllSumPx;   //!
   TBranch        *b_pvAllSumPy;   //!
   TBranch        *b_pvAllSumPz;   //!
   TBranch        *b_pvPUz;   //!
   TBranch        *b_pvNtrack;   //!
   TBranch        *b_pvNtrack_reco;   //!
   TBranch        *b_pvIndex;   //!
   TBranch        *b_allNtrack;   //!
   ...
   TBranch        *b_allTrackPhi;   //!
   TBranch        *b_allTrackEta;   //!
   TBranch        *b_allTrackX;   //!
   TBranch        *b_allTrackY;   //!
   TBranch        *b_allTrackZ;   //!
   TBranch        *b_allTrackDz;   //!
   ...
   TBranch        *b_pvAllSumPz_dt;   //!
   TBranch        *b_pvNtrack_dt;   //!
   TBranch        *b_nBunchXing;   //!
   TBranch        *b_BunchXing;   //!
   TBranch        *b_BunchXingIndex;   //!
   TBranch        *b_nPU;   //!
   TBranch        *b_nPUmean;   //!
   TBranch        *b_puZposition;   //!
   ...
   TBranch        *b_pho_superClusterSeedE;   //!
   TBranch        *b_pho_pfClusterSeedE;   //!
   ...
   TBranch        *b_genVertexZ2;   //!
   TBranch        *b_genVertexX2;   //!
   TBranch        *b_genVertexY2;   //!
...
UpgradeAna::UpgradeAna(TTree *tree) : fChain(0) 
{
...
Int_t UpgradeAna::GetEntry(Long64_t entry)
{
...
void UpgradeAna::Init(TTree *tree)
{
   ...
   fChain->SetBranchAddress("pvX_New", &pvX_New, &b_pvX_New);
   fChain->SetBranchAddress("pvY_New", &pvY_New, &b_pvY_New);
   fChain->SetBranchAddress("pvZ_New", &pvZ_New, &b_pvZ_New);
   ...
   fChain->SetBranchAddress("pvAllXError", pvAllXError, &b_pvAllXError);
   fChain->SetBranchAddress("pvAllY", pvAllY, &b_pvAllY);
   fChain->SetBranchAddress("pvAllYError", pvAllYError, &b_pvAllYError);
   fChain->SetBranchAddress("pvAllZ", pvAllZ, &b_pvAllZ);
   fChain->SetBranchAddress("pvAllZError", pvAllZError, &b_pvAllZError);
   fChain->SetBranchAddress("pvAllT", pvAllT, &b_pvAllT);
   fChain->SetBranchAddress("pvAllTError", pvAllTError, &b_pvAllTError);
   ...
   fChain->SetBranchAddress("pvAllSumPz", pvAllSumPz, &b_pvAllSumPz);
   fChain->SetBranchAddress("pvPUz", pvPUz, &b_pvPUz);
   fChain->SetBranchAddress("pvNtrack", pvNtrack, &b_pvNtrack);
   fChain->SetBranchAddress("pvNtrack_reco", pvNtrack_reco, &b_pvNtrack_reco);
   fChain->SetBranchAddress("pvIndex", pvIndex, &b_pvIndex);
   fChain->SetBranchAddress("allNtrack", &allNtrack, &b_allNtrack);
   ...
   fChain->SetBranchAddress("allTrackT", &allTrackT, &b_allTrackT);
   fChain->SetBranchAddress("allTrackPt", &allTrackPt, &b_allTrackPt);
   fChain->SetBranchAddress("allTrackdZ", &allTrackdZ, &b_allTrackdZ);
   fChain->SetBranchAddress("allTrackPhi", &allTrackPhi, &b_allTrackPhi);
   fChain->SetBranchAddress("allTrackEta", &allTrackEta, &b_allTrackEta);
   ...
   fChain->SetBranchAddress("pvAllSumPz_dt", pvAllSumPz_dt, &b_pvAllSumPz_dt);
   fChain->SetBranchAddress("pvNtrack_dt", pvNtrack_dt, &b_pvNtrack_dt);
   fChain->SetBranchAddress("nBunchXing", &nBunchXing, &b_nBunchXing);
   fChain->SetBranchAddress("BunchXing", BunchXing, &b_BunchXing);
   fChain->SetBranchAddress("BunchXingIndex", BunchXingIndex, &b_BunchXingIndex);
   fChain->SetBranchAddress("nPU", nPU, &b_nPU);
   fChain->SetBranchAddress("nPUmean", nPUmean, &b_nPUmean);
   fChain->SetBranchAddress("puZposition", &puZposition, &b_puZposition);
   ...
   fChain->SetBranchAddress("pho_superClusterSeedE", pho_superClusterSeedE, &b_pho_superClusterSeedE);
   fChain->SetBranchAddress("pho_pfClusterSeedE", pho_pfClusterSeedE, &b_pho_pfClusterSeedE);
   ...
   fChain->SetBranchAddress("genVertexZ2", &genVertexZ2, &b_genVertexZ2);
   fChain->SetBranchAddress("genVertexX2", &genVertexX2, &b_genVertexX2);
   fChain->SetBranchAddress("genVertexY2", &genVertexY2, &b_genVertexY2);
...
void UpgradeAna::Show(Long64_t entry)
{
...
Int_t UpgradeAna::Cut(Long64_t entry)
{
...
double UpgradeAna::DeltaPhi(double phi1, double phi2) {
...
double UpgradeAna::DeltaR(double eta1, double phi1, double eta2, double phi2) {
