...
process.source = cms.Source("PoolSource",
    fileNames = cms.untracked.vstring(
        'root://cms-xrd-global.cern.ch//store/mc/RunIISummer17MiniAOD/XXTo4J_M-300_CTau-1000mm_TuneCUETP8M1_13TeV_pythia8/MINIAODSIM/NZSFlatPU28to62_92X_upgrade2017_realistic_v10-v1/150000/668D877E-56AD-E711-A37B-0025905B85CA.root'
    )
)
...
process.ntuples = cms.EDAnalyzer('RazorTuplizer', 
    ...
    #jetsAK8SoftDropPacked = cms.InputTag("selectedPatJetsAK8PFCHSS"),
